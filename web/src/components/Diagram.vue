...
export default {
  ...
  created: async function() {
    console.log('Re:', this.recomendations)
    ...
    let isRecommended = currentMacroTask.taskName in this.recomendations
  ...
  methods: {
    ...
    getBlockHtml(macroTask) {
      ...
      let isRecommended = taskName in this.recomendations
      if (isRecommended) {
        actions.forEach(action => {
          console.log(
            'Block HTML: ',
            action.name,
            this.recomendations[taskName]
          )
          if (this.recomendations[taskName].includes(action.name)) {
            console.log('Found')
      ...
      // <span ><i class=""></i></span>
      console.log('blockHTML', this.recomendations, taskName, isRecommended)
      let template = `
