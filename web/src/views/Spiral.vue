                    ...
                    <v-list-item-title>
                      <div class="text-h6">
                        ...
                        <v-tooltip top>
                          ...
                          <span
                            >Segments used for every cycle in the spiral</span
                          >
                        </v-tooltip>
                      </div>
                    </v-list-item-title>
            ...
            <v-list-item>
              <v-list-item-content>
                <v-row justify="center">
                  ...
                  <v-col cols="11">
                    <vue-slider v-model="rangeYear" :min="2" :max="10">
                    </vue-slider>
                  </v-col>
                </v-row>
              </v-list-item-content>
                      ...
                      ><div class="text-h6">
                        ...
                        <v-tooltip top>
                          ...
                          <span
                            ...
                            are set due to visualization reasons).</span
                          >
                        </v-tooltip>
                      </div>
                    </v-list-item-title>
...
export default {
  ...
  methods: {
    ...
    async getPeriodRecomendations() {
      let feat_idx = this.features.indexOf(this.feature)
      let segment_recomendation = await axios.get(
        `http://localhost:8081/data/${this.dataset}/period?feature=${feat_idx}`,
        { crossdomain: true }
      )

      this.guide_cycle = segment_recomendation.data.periods
    },
